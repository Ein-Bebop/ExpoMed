<?php
    ...
    if (!$conn) {//Si la conexión no es exitosa no muestra los datos
        ...
        if($_FILES['foto']['name'] != ""){
            ...
            if(unlink(dirname(__FILE__)."/../../assets/talleres/".$foto)){
            ...
            $sql = "UPDATE talleres SET tipo= '".$tipo."', nombre = '".$nombre."', imparte='".$imparte."', brief='".$brief."', link='".$link."', img='".$new_filename."' WHERE idTaller='".$id."'";
        }else{
            $sql = "UPDATE talleres SET tipo= '".$tipo."', nombre = '".$nombre."', imparte='".$imparte."', brief='".$brief."', link='".$link."' WHERE idTaller='".$id."'";
        }
