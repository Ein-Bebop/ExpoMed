<?php
    ...
    if (!$conn) {//Si la conexión no es exitosa no muestra los datos
        ...
        if($_FILES['foto']['name'] != ""){
            ...
            $f_folder = "../../assets/eventos/" . DIRECTORY_SEPARATOR . $new_filename;//Ruta del archivo a la carpeta dentro del host
            ...
            if(unlink(dirname(__FILE__)."/../../assets/eventos/".$foto)){
            ...
            $sql = "UPDATE eventos SET tipo= '".$tipo."', nombre = '".$nombre."', imparte='".$imparte."', brief='".$brief."', link='".$link."', img='".$new_filename."' WHERE idTaller='".$id."'";
        }else{
            $sql = "UPDATE eventos SET tipo= '".$tipo."', nombre = '".$nombre."', imparte='".$imparte."', brief='".$brief."', link='".$link."' WHERE idTaller='".$id."'";
        }
        ...
        $noti = "Evento actualizado con éxito";
